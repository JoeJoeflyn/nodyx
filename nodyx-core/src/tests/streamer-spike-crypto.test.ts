// ─── Streamer Hub spike — tests négatifs de chiffrement (§12.1) ──────────────
...
import { encrypt, decrypt } from '../spike/streamer/crypto'

describe('streamer spike crypto — round-trip', () => {
...
describe('streamer spike crypto — tests négatifs (§12.1)', () => {
